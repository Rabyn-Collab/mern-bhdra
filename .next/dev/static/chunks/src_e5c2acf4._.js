...
function Spinner(t0) {
    ...
    if ($[0] !== "9b4de78b52ddac0e52268ffa4dba6ac4bb20ce22d3064f3d63da143a7c0ed333") {
        for(let $i = 0; $i < 9; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "9b4de78b52ddac0e52268ffa4dba6ac4bb20ce22d3064f3d63da143a7c0ed333";
    }
    let className;
    let props;
    if ($[1] !== t0) {
    ...
    let t1;
    if ($[4] !== className) {
        t1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("size-4 animate-spin", className);
        $[4] = className;
        $[5] = t1;
    } else {
        t1 = $[5];
...
"[project]/src/utils/firebaseFirestore.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$firebaseFirestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/firebaseFirestore.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@firebase/firestore/dist/index.esm.js [app-client] (ecmascript)");
...
;
;
function EditPost(t0) {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(14);
    if ($[0] !== "39fc0ed9370e562ff361a97b498ce2a423be46e585c3f3dcc31ddb8b6e8dd746") {
        for(let $i = 0; $i < 14; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "39fc0ed9370e562ff361a97b498ce2a423be46e585c3f3dcc31ddb8b6e8dd746";
    }
    const { post } = t0;
    const [isPending, startTransition] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTransition"])();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    let t1;
    if ($[1] !== post.detail || $[2] !== post.image || $[3] !== post.title) {
        t1 = {
            title: post.title,
            detail: post.detail,
            image: post.image
    ...
    let t2;
    if ($[5] !== post.id || $[6] !== router) {
        t2 = ({
            "EditPost[<Formik>.onSubmit]": (val)=>{
                startTransition({
                    "EditPost[<Formik>.onSubmit > startTransition()]": async ()=>{
                        ;
                        try {
                            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$firebaseFirestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "posts", post.id), val);
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success("Post added successfully");
                            router.back();
                        } catch (t3) {
                            const err = t3;
                ...
                }["EditPost[<Formik>.onSubmit > startTransition()]"]);
            }
        })["EditPost[<Formik>.onSubmit]"];
        $[5] = post.id;
        $[6] = router;
        $[7] = t2;
    } else {
    ...
    if ($[8] !== isPending) {
        t3 = (t4)=>{
            const { handleChange, handleSubmit, values } = t4;
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"], {
                            ...
                            fileName: "[project]/src/components/EditPost.tsx",
                            lineNumber: 74,
                            columnNumber: 80
                        }, this)
                    }, void 0, false, {
...
_s(EditPost, "r0+bhqBgOc5BXO1NQwYvB0wIgU4=", false, function() {
    return [
...
//# sourceMappingURL=src_e5c2acf4._.js.map